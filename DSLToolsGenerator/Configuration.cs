...
namespace DSLToolsGenerator.Parser
{
    public record ParserConfiguration
    {
        ...
        /// <summary>
        /// The command that can be used to launch the ANTLR tool.
        /// Usually either <c>antlr</c> or <c>java -jar /path/to/antlr.jar</c>
        /// </summary>
        [DefaultValue("antlr")]
        public string? AntlrCommand { get; init; }

        /// <summary>
        /// What output directory path to pass to ANTLR
        /// (if the <c>Parser</c> output is enabled).
        /// </summary>
        [DefaultValue("Parser")]
